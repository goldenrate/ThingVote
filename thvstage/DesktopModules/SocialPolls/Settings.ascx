<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Settings.ascx.cs" Inherits="DotNetNuke.Modules.SocialPolls.Settings" %>
...
<%@ Register TagName="label" TagPrefix="dnn" Src="~/controls/labelcontrol.ascx" %>
 ...
 --%>   
    <h2 id="H1" class="dnnFormSectionHead">
        <a href="#" class="dnnSectionExpanded">Init Application</a></h2>
    <fieldset>
        <legend>Initialize the Application </legend>
         <div class="dnnFormItem">         
