...
"block"),c=c.attr("data-thumb"),b.load(function(){}).attr("src",c),b.error(function(){}),d.append(b),X.append(d),ob.push(d);Ic(ob)}function bd(a){if(!a)a=window.event;a.cancelBubble?a.cancelBubble=!0:a.stopPropagation&&a.stopPropagation();if(T&&!oa&&!q&&(a=i(a.currentTarget).attr("id"),a!=x()))return qb=!0,"KEN_BURNS"!=z?Q?q||(M=a,q=!0):(rb(),Z=a,Sb()):!Aa&&!q&&(M=a,q=!0,j&&clearTimeout(j),Sa()),!1}function rb(){Qb&&Qb.css("cursor","pointer")}function nc(){var a=ob[x()];
a.css("cursor","default");Qb=a}function Tb(a){if(!Ja){Ub=!0;var b,c=i(Ha[a]),d,p,f=ya[o].main;b=i(new Image);b.attr("id",a);b.css("top",0);b.css("left",0);b.css("display","block");if("SLIDE"==z||"SPLIT"==z||"REVEAL"==z)b.css("position","absolute");else if("KEN_BURNS"==z||"ALPHA"==z||"ZOOM"==z)b.css("position","relative"),b.css("width","100%"),b.css("height","100%");a=c.attr("data-main");b.load(function(){d=i(this);p=d.attr("id");this.origWidth=this.width;this.origHeight=
