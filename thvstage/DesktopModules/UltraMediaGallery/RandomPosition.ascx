<%@ Control Language="vb" AutoEventWireup="false" Codebehind="RandomPosition.ascx.vb" Inherits="BizModules.UltraPhotoGallery.RandomPosition" %>
<script type="text/javascript" src='<%=ModulePath%>Scripts/swfobject.js'></script>
<div id='UMGContainer<%=ModuleId%>' style="background-color:#000000">
